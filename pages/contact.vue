<template>
    <div class='m-10 mt-16 md:m-20 xl:mx-40'>
        <div v-if='!sent' class='bg-white dark:bg-charcoal shadow-light_3xl dark:shadow-3xl rounded-md p-10 grid grid-cols-1 md:grid-cols-2'>
            <div class='p-5 pr-10'>
            ...
            <form class='flex flex-col'>
                ...
                <textarea v-model='mail.text' placeholder='Message' class='border-solid border-gray-300 dark:border-dblue border-2 dark:bg-dblue mb-5 rounded-md h-32 p-2 focus:outline-none focus:border-gray-500'></textarea>

<template>
    <div 
        class="h-60 rounded-md shadow-lg dark:shadow-xl hover:animate-bounce_sm" 
        @mouseover="hover = true" 
        @mouseleave="hover = false"
    >
        <nuxt-img :src='project.imgs[0]' blur-up class='h-full w-full object-cover rounded-md'/>
        <div 
            v-if='hover'
        ...
        >
            <div class='flex flex-col justify-between text-white'>
                ...
                <div class='flex justify-between'>
                    <div class='flex'>
                        <nuxt-img src='/icons/cursor-arrow.svg' class='invert h-5 mt-1' alt='cursor icon' />
                        <i>Click to read</i>
                    </div>
                    <div class='flex'>
